...
First, read the agent specification file that defines what agent to build:
...
Create `feature_list.json` with 50-100 granular test cases.
...
Create `init_agent.sh` to set up the agent environment:
